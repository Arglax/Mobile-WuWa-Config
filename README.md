...
|------|--------|-------------|
| [Mobile Config Selector](https://arglax.github.io/Mobile-WuWa-Config/index.html) | 🟢 Live | Search your phone unit, CPU, or GPU family to instantly discover and link your recommended performance preset. |
| [DeviceProfiles.ini Generator](https://arglax.github.io/Mobile-WuWa-Config/tools/devprof-generator.html) | 🟡 WIP / Live | Generate a `DeviceProfiles.ini` tailored to your device |
| [Client.log Decryptor](https://arglax.github.io/Mobile-WuWa-Config/tools/log-decryptor.html) | 🟢 Live | Decrypt WuWa's encrypted client logs in-browser |
| Engine.ini Generator | 🔜 Coming Soon | — |
| Crash Log Analyzer | 🔜 Coming Soon | — |
=======
| Utility Tool | Stability Status | Capabilities & Features |
| :--- | :---: | :--- |
| **[Client.log Decryptor](https://arglax.github.io/Mobile-WuWa-Config/tools/log-decryptor.html)** | `🟩 LIVE` | • Instantly decrypts Kuro's obfuscated logs locally in-browser.<br>• Extracts retail phone models (e.g., *Poco X6 Pro 5G*) + Kuro's assigned hardware profile name.<br>• Automated diagnostic scans for critical runtime errors and framework crashes. |
